...
elements_dict = {
    ...
    'Pb': {'model': 'MLP_3_hidden','lr': 0.0012, 'num_epochs': 1000, 'hidden_layers': [512, 256, 128]},
...
# 加载保存好的数据集
train_data = np.load(f'./dataset/融合特征/data_{current_element_lower}_train.npy')
train_label = np.load(f'./dataset/全光谱/full_{current_element}_label_train.npy')
test_data = np.load(f'./dataset/融合特征/data_{current_element_lower}_test.npy')
