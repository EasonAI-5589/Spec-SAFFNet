...
# 元素对应超参数字典
elements_dict = {
    'Cu': {'model': 'MLP_3_hidden','lr': 0.001, 'num_epochs': 2000, 'hidden_layers': [512, 256, 128]},
...
# elements_dict = {
#     'Cu': {'model': 'MLP','lr': 0.002, 'num_epochs': 2000, 'hidden_layers': [32,16]},
#     'Zn': {'model': 'MLP_3_hidden','lr': 0.0015, 'num_epochs': 1800, 'hidden_layers': [512, 256, 128]},
#     'Pb': {'model': 'MLP_3_hidden','lr': 0.0015, 'num_epochs': 1800, 'hidden_layers': [512, 256, 128]},
#     'V': {'model': 'MLP_3_hidden','lr': 0.0015, 'num_epochs': 2500, 'hidden_layers': [512, 256, 128]},
# }
...
# 加载保存好的数据集
train_data = np.load(f'./dataset/全光谱特征选择/selected_data_train.npy')
train_label = np.load(f'./dataset/全光谱/full_{current_element}_label_train.npy')
test_data = np.load(f'./dataset/全光谱特征选择/selected_data_test.npy')
...
# 读取之前的模型评估结果
model_path = f'./model/全光谱/mlp+特征选择/best_model_{current_element}.pth'
results_path = f'./model/全光谱/mlp+特征选择/best_model_{current_element}.txt'
