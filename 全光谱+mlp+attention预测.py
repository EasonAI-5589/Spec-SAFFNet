...
# 读取之前的模型评估结果
model_path = f'./model/quanguangpu/mlpattention/best_model_{current_element}.pth'
results_path = f'./model/quanguangpu/mlpattention/best_model_{current_element}.txt'
